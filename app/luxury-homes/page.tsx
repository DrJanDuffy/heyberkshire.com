...
export const metadata: Metadata = {
  ...
  description:
    "Discover Las Vegas luxury real estate with Dr. Jan Duffy at Berkshire Hathaway HomeServices Nevada Properties. The Ridges, Summerlin, Southern Highlands. $1M+ homes. Call 702-222-1964.",
  keywords: [

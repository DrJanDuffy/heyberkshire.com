            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-slate-600 text-sm mb-3">
                  0% state income tax, 40-60% lower prices. See what your CA equity buys here.
                </p>
              ...
              >
                ...
                <p className="text-slate-600 text-sm mb-3">
                  Down payment assistance, FHA/VA loans, and builder incentives explained.
                </p>
                <span className="text-blue-600 font-semibold text-sm">Learn More →</span>
              </Link>
              <Link
              ...
              >
                ...
                <p className="text-slate-600 text-sm mb-3">
                  $1M+ properties with discrete service. The Ridges, MacDonald Highlands & more.
                </p>
                <span className="text-blue-600 font-semibold text-sm">Learn More →</span>
              </Link>
            </div>
